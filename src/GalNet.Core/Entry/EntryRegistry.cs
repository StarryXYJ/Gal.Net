...
public static class EntryRegistry
{
    ...
    private static IReadOnlyDictionary<string, EntryDefinition> BuildDefinitions()
    {
        var definitions = new[]
        {
            ...
            Define(AnimateLayerEntry.TypeId, "Animation", () => new AnimateLayerEntry(), AnimateLayerEntry.ParameterTypes, AnimateLayerEntry.DefaultValues, AnimateLayerEntry.ParameterOptions),
